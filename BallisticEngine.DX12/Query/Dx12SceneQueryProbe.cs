...
public static class Dx12SceneQueryProbe {
    public static unsafe bool SelfTest(Dx12Device dev) {
        ...
        try {
            ...
            var inside  = new Vector3(0, 0, 0);
            var outside = new Vector3(50, 0, 0);
            var farOpen = new Vector3(100, 100, 0);
            ...
            bool[] vis = query.Visibility(new[] {
                (inside, outside), (new Vector3(50, 0, 0), new Vector3(50, 50, 0))
            });
            ...
            var roomPts = new[] {
                new Vector3( 3, 0, 0), new Vector3( 3, 0.5f, 0), new Vector3(-3, 0, 0), new Vector3(-3, 0.5f, 0),
            };
